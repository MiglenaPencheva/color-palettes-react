    ...
    return (
        <section className="explore__color-names">
            ...
            {language.lang === 'en' ? (
                ...
                <article>
                    Съвременните браузъри поддържат 140 стандартни имена на цветове.
                    <br />Мостри с имената им и техните хекс стойности (шеснайсетични кодове) са изброени по-надолу по азбучен ред.
