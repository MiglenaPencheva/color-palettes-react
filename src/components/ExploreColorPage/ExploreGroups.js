    ...
    return (
        <section className="explore__color-names">
            ...
            <article>{language.lang === 'en'
                ...
                : 'Съвременните браузъри поддържат 140 стандартни имена на цветове. Мостри с имената и техните хекс стойности (шеснайсетични кодове) са изброени по-надолу по групи.'}
            </article>
