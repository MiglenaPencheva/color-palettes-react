        ...
        <section className="explore__rgb-mixer">
            ...
            {language.lang === 'en'
                ...
                : <p>В модела HSL <b><i>цветът</i></b> съответства на градус от цветното колело - от 0 до 360.
                    <br />С 0% <b><i>наситеност</i></b> той се обезцветява, превръща се в тон, сив оттенък.  
                    Докато 100% наситеност представляват чистият цвят.
                    <br />Затъмняването на цвета, го превръща в сянка, тъмен оттенък. 0% <b><i>яркост</i></b> означава черно.
