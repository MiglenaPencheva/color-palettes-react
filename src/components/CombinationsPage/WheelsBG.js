const WheelsBG = () => {
    ...
    return (
        <section id="schemeDetailsSection" className="ryb__details">
            ...
            <article> При субстрактивните модели се отнема от сектъра на светлинния поток. Липсата на цвят означава бяло, 
                ...
                на традиционната теория на цветовете и е широко използвана от артисти, художници и дизйнери 
            ...
            в който циян, маджента и жълто се смесват до получаване на черно, но липсва начин за постигане на бяло. 
