...
const NeutralsBG = () => {
    ...
    return (
        <section className="ryb__details">
            <h5 className="ryb__info">Комбинирай с неутрални цветове</h5>
            ...
            <article>
                ...
                <br />
                Те са в разнообразието от <b>дървестни</b> текстури.
            </article>
            ...
            <article>
                Температурата също така зависи и се повлиява от околните цветове.
            </article>

            <h6>Защо с неутрални цветове се получават добри цветови комбинации?</h6>
            <article>
