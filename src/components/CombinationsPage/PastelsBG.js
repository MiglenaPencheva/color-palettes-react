...
const PastelsBG = () => {
    ...
    return (
        <section id="schemeDetailsSection" className="ryb__details">
            ...
            <article>
                Голямата група на <Link to="/combinations/neutrals" target="_blank"><b><i>неутралните цветове</i></b></Link> включва
            ...
            <article>
                ...
                Пастелите носят сладостта на пролетта, цветята и бонбоните.
            </article>
            ...
            <article>
                ...
                както с използването на по-светли и по-тъмни оттенъци от една цветна група,
                така и с комбинирането на взаимно допълващи се цветове.
                Съчетаването на много и различни нюанси е друг силен подход,
                разкриващ богатството в разнообразието и все пак запазващ хармонията в композицията.
