...
export const getInfoCombinationsBG = {
    'Choose scheme': '',
    'complementary': 'Допълващата цветова схема събира два противоположни цвята от цветното колело. Това е хармонията, предлагаща най-голям контраст. Привличаща най-силно вниманието. Единият цвят от двойката е доминиращ. Другият го подсилва и подчертава или се използва за акцент. В тази най-динамична комбинация участват едновременно топъл и студен цвят. Според темературата на доминиращия цвят цялостният дизайн изглежда или топъл, или студен. Атрактивна и трудна за балансиране, допълващата схема предлага остра, ярка и силна визия.',
    'splitComplementary': 'Разделно допълващата цветова схема е вариация на допълващата цветова схема. Събира един основен цвят с двата, съседни на срещуположния му в цветното колело. С добавянето на трети акцент в композицията се отнема от напрежението на дръзкия двуполюсен контраст. Намаляват остротата и жизнеността. Противопоставянето запазва равновесието между топли и студени цветове. Разделно допълващата схема е трудна за балансиране, но предлага атрактивност и хармонична визия.',
    'monochromatic': 'Монохромната цветова схема използва един основен цвят и неговите оттенъци - нюанси, сенки и тонове, получени с добавянето на бяло, черно или сиво. Лесна е за създаване, с лекота се прилага и възриема. Тази цветова схема излъчва чистота и елегантност. Липсата на контраст я прави фина и деликатна и носи успокояващ ефект. Динамика може да бъде постигната с комбинирането на тъмни сенки и светли нюанси и дори черно и бяло. Изпoлзването на един цвят и неговите вариации придава дързост и драматизъм, но също така постига балансирана и стилна визия.',
    'analogous3': 'Аналогичната цветова схема използва съседни цветове, подредени един до друг в цветното колело. Лесно се създава и има приятно и елегантно излъчване. Един доминиращ цвят, допълнен с останалите, прави това съчетание хармонично и успокояващо. Цветовете не се сблъскват един с друг, подобни комбинации са често и естествено явление в природата. Липсата на контраст намалява жизнеността. Съседните цветове си пасват по-добре, когато всичките са представители или на топлата, или на студената гама.',
    'analogous5': 'Аналогичната цветова схема използва съседни цветове, подредени един до друг в цветното колело. Лесно се създава и има приятно и елегантно излъчване. Един доминиращ цвят, допълнен с останалите, прави това съчетание хармонично и успокояващо. Цветовете не се сблъскват един с друг, подобни комбинации са често и естествено явление в природата. Липсата на контраст намалява жизнеността. Съседните цветове си пасват по-добре, когато всичките са представители или на топлата, или на студената гама.',
    'triadic': 'Триадичната цветова схема съчетава три цвята, които са разположени на еднакво разстояние един от друг в цветното колело. Един основен цвят се балансира от два равнопоставени - акценти. Комбинацията предлага едновременно силен контраст и хармония. Жизнеността се запазва дори при използването на бледи и обезцветени вариации на цветовете. Триъгълната цветова схема се постига лесно и осигурява динамика и богатство на цветовете.',
    'tetradic1': 'Тетрадичната цветова схема се нарича също четириъгълна или двойно доълваща. Четирите цвята са комбинирани като две допълващи се двойки от цветното колело. Това по-сложно съчетание затруднява постигането на баланс и хармония. Един от цветовете следва да бъде доминиращ, а останалите могат да участват с пастелните си или обезцветени оттенъци. Двойките образуват <b><i>правоъгълна схема</i></b> или <b><i>квадратна схема</i></b>, ако подбраните цветове отстоят на равни разстояния един от друг. Тетрадичната е най-богата цветова схема и дава възможност за широк избор и разнообразни комбинации.',
    'tetradic2': 'Тетрадичната цветова схема се нарича също четириъгълна или двойно доълваща. Четирите цвята са комбинирани като две допълващи се двойки от цветното колело. Това по-сложно съчетание затруднява постигането на баланс и хармония. Един от цветовете следва да бъде доминиращ, а останалите могат да участват с пастелните си или обезцветени оттенъци. Двойките образуват <b><i>правоъгълна схема</i></b> или <b><i>квадратна схема</i></b>, ако подбраните цветове отстоят на равни разстояния един от друг. Тетрадичната е най-богата цветова схема и дава възможност за широк избор и разнообразни комбинации.',
    'square': 'Тетрадичната цветова схема се нарича също четириъгълна или двойно доълваща. Четирите цвята са комбинирани като две допълващи се двойки от цветното колело. Това по-сложно съчетание затруднява постигането на баланс и хармония. Един от цветовете следва да бъде доминиращ, а останалите могат да участват с пастелните си или обезцветени оттенъци. Двойките образуват <b><i>правоъгълна схема</i></b> или <b><i>квадратна схема</i></b>, ако подбраните цветове отстоят на равни разстояния един от друг. Тетрадичната е най-богата цветова схема и дава възможност за широк избор и разнообразни комбинации.',
};
